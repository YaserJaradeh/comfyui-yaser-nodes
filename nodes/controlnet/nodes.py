...
# Simple logging utility (replacing the utils.log dependency)
class SimpleLogger:
    def info(self, msg):
        print(f"[INFO] {msg}")
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "WanVideoControlnetLoader": "WanVideo Controlnet Loader - Yaser",
    "WanVideoControlnet": "WanVideo Controlnet Apply - Yaser",
    }
